...
function Component({ checked, Title, handleClick, handleDelete, show,handleshow,handlechange }) {
  ...
  return (
    <div class="container5" >
      ...
      <button  name={Title} onClick={()=>handleshow(Title)} type="button" style={transform}>
